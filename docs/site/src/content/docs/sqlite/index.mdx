---
title: The Graft SQLite Extension (libgraft)
description: A native SQLite extension that works anywhere SQLite does
---
...
The Graft SQLite extension should work with any version of [SQLite](https://www.sqlite.org/index.html) after 3.44.0 (released Nov 2023). It probably works with earlier versions, but no guarantees.

## Downloading `libgraft`

### Manual download

`libgraft`, is released using [GitHub Releases](https://github.com/orbitinghail/graft/releases/latest) for most platforms. You can access the latest release using the links below:

| Platform | Architecture | Download Link                   |
| -------- | ------------ | ------------------------------- |
| Linux    | x86_64       | [libgraft-linux-x86_64.tar.gz](https://github.com/orbitinghail/graft/releases/latest/download/libgraft-linux-x86_64.tar.gz)  |
| Linux    | aarch64      | [libgraft-linux-aarch64.tar.gz](https://github.com/orbitinghail/graft/releases/latest/download/libgraft-linux-aarch64.tar.gz) |
| Windows  | x86_64       | [libgraft-windows-x86_64.zip](https://github.com/orbitinghail/graft/releases/latest/download/libgraft-windows-x86_64.zip)   |
| Windows  | aarch64      | [libgraft-windows-aarch64.zip](https://github.com/orbitinghail/graft/releases/latest/download/libgraft-windows-aarch64.zip)  |
| macOS    | x86_64       | [libgraft-macos-x86_64.tar.gz](https://github.com/orbitinghail/graft/releases/latest/download/libgraft-macos-x86_64.tar.gz)  |
| macOS    | aarch64      | [libgraft-macos-aarch64.tar.gz](https://github.com/orbitinghail/graft/releases/latest/download/libgraft-macos-aarch64.tar.gz) |
...
Rather than having to download and manage the extension manually, `libgraft` is available through the [sqlpkg](https://github.com/nalgeon/sqlpkg-cli) SQLite extension manager! This means you can download the extension like so:
...
The author of `sqlpkg`, [Anton Zhiyanov](https://www.linkedin.com/in/nalgeon/), published a comprehensive guide to SQLite extensions on their blog [which is available here](https://antonz.org/install-sqlite-extension/). I highly recommend reading that post for more ways to install and use SQLite extensions.
