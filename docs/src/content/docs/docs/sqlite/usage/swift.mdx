---
title: Swift
description: Use the Graft SQLite extension with Swift on iOS and macOS
sidebar:
  order: 3
---
...
See the [configuration documentation](/docs/sqlite/config/) for complete details.
...
See the [pragmas documentation](/docs/sqlite/pragmas/) for all available commands.

[Graft.swift]: https://github.com/orbitinghail/Graft.swift
